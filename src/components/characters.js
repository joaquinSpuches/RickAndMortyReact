        ...
        <section>   
            ...
            <ul class="w-full flex flex-wrap gap-9">
                ...
                <div class="flex w-full items-center justify-center align-middle gap-6 p-6">
                    <button onClick={handleClickPrev} class="bg-gray-500 border-solid border-2 border-black p-6 " >prev</button>
                    <button onClick={handleClickNext} class="bg-gray-500 border-solid border-2 border-black p-6 h-full">next</button>
                </div>
        </section>
    )
}	