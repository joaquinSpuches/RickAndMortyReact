...
function Episode() {
    ...
    if(episodes.find(episode => episode.name === param) === undefined) {
        ...
        var episode = episodes.find(episode => episode.name === param);
    }
    console.log(episodes.find(episode => episode.name === param))
    ...
    return (
        <div className="flex flex-col items-start mx-8">
            ...
            <ul class="w-full flex flex-wrap w-full justify-center gap-9">
